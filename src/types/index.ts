...
export interface WidgetConfig {
  ...
  type: WidgetType;
  title: string;
  dataRange: string;       // e.g. "Skor_IAA!A1:Z200"
  chartType?: ChartType;
  color?: string;          // primary color hex
  xKey?: string;           // which column to use as X axis
  yKeys?: string[];        // which columns to plot
}
...
export interface ApiStatsResponse extends Stats {
  ok: true;
}
...
export const PRESET_COLORS = [
  "#378ADD", "#EF9F27", "#E05C5C",
  "#1D9E75", "#9B6CF7", "#F06292",
  "#26C6DA", "#8D6E63", "#546E7A",
];
